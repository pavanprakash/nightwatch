...
module.exports = {
    ...
    "Verify if Late Deals Link is navigating to the correct page" : function (browser) {
        browser
    ...
    "Verify if Destinations Link is navigating to the correct page" : function (browser) {
        browser
            ...
            // Check URL
            .assert.urlEquals(baseurl+"destination", "Verified Destinations Link Navigates to correct Page")
            //verify if the header text is correct
            .assert.containsText("#mainNavWrapper > ul > li.icon.HotelDestinations > a","Destinations","Verified if header text is Destinations")
            .end();
    },
